# Wizard laravel livewire package

This file is for coding agents working in this repo. Follow it literally.

## Project context

- **Wizard is a laravel livewire package**: it a livewire feature (hook) for creating wizards/step forms.
...
- **Prefer Contracts + Dependency injection** over facades or `app()`. Provide a facade as a convenience layer for end-users of the package, while keeping internal code DI-based.
...
## Frontend (Livewire + Blade + Tailwind + Alpine)

- **Do things the Livewire v3+ way.**
...
- Make use of computed properties
- Support livewire v4, but also backwards compatible to livewire v3
...
- **Static analysis:** `./vendor/bin/phpstan`. Uses larastan/larastan. Do not suppress/ignore issues at level 7
